...
public class JobInfoController {
    ...
    private void handleApply() {
        if (nameField.getText().isEmpty() || phoneNumberField.getText().isEmpty() || skills.isEmpty()) {
            ...
            Applicant applicant = new Applicant(Database.getCurrentUser().getUsername(), name, phoneNumber, jobRole.getJobName());
            ...
            System.out.println("Username: " + applicant.getUniqueUserID());
